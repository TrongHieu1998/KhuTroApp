package com.example.khutroapp.ui.screens.activity_invoice.fragment_unpaid.model;

public class UnpaidModel {
    public String mahdn,thangnam,maphong,tiendien,tiennuoc,tienwifi,tienrac,tienphong,tongtien;

    public UnpaidModel(String mahdn, String thangnam, String maphong, String tiendien, String tiennuoc, String tienwifi, String tienrac, String tienphong, String tongtien) {
        this.mahdn = mahdn;
